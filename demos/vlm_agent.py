...
@click.option("--mission", default="Professor oak has invited you into his lab and offered you a choice of starter pokemon. You are to select a starter, leave the building from the bottom, and keep playing until you get the first gym badge.", type=str)
@click.option("--visual_context", default="You are in Professor oaks lab, professor oak is right in front of you and your rival BLUE is slightly to the left and in front of you. To your right (and a little up), is a bench with three starter pokeballs on it. The exit of the building is downwards.", type=str)
...
def do(model_name, init_state, game_variant, mission, visual_context, max_steps):
    ...
    vl = SimpleSupervisor(game=game_variant, environment=environment, 
                          executor_class=PokemonExecutor, execution_report_class=SimplePokemonExecutionReport,
