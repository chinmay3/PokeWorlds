...
from poke_worlds.emulation.pokemon import get_pokemon_emulator, PokemonEmulator, infer_variant
...
def get_pokemon_environment(game_variant: str, *, parameters: dict = None, controller=None, environment_variant="default", environment_kwargs={}, **kwargs) -> PokemonEnvironment:
    """
    ...
    environment = variant_map[environment_variant](emulator=emulator, controller=controller, 
