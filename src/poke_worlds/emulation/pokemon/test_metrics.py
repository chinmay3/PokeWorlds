...
class DefeatedBrockTerminateMetric(RegionMatchTerminationMetric, TerminationMetric):
    REQUIRED_PARSER = PokemonRedStateParser
...
class DefeatedLassTerminateMetric(RegionMatchTerminationMetric, TerminationMetric):
    REQUIRED_PARSER = PokemonRedStateParser
